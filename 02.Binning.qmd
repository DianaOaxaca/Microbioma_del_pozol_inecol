...
export PATH=/lustre/apps/spack/opt/spack/linux-centos8-ivybridge/gcc-8.3.1/miniconda3-4.7.12.1-ubp7tlghaseisza4pqufq6sbehwa4pog/envs/checkm/bin:$PATH

dRep dereplicate results/09.drep/ -comp 50 -con 10  -g results/09.drep/bins/*.fasta
```
